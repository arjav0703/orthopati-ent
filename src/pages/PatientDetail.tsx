...
const PatientDetail = () => {
  ...
  const handleDeletePatient = () => {
    if (id && window.confirm('Are you sure you want to delete this patient? This action cannot be undone.')) {
            ...
            {!isEditMode && (
              <>
                <button 
                  ...
                  className="flex items-center gap-1 px-3 py-2 rounded-lg hover:bg-secondary transition-all-medium"
                >
                  <Edit size={16} />
                  <span>Edit</span>
                </button>
                <button 
                  ...
                  className="flex items-center gap-1 px-3 py-2 rounded-lg text-destructive hover:bg-destructive/10 transition-all-medium"
                >
                  <Trash2 size={16} />
                  <span>Delete</span>
                </button>
            ...
            {isEditMode && (
              <>
                ...
                <button 
                  ...
                  className="flex items-center gap-1 px-3 py-2 rounded-lg bg-primary text-primary-foreground hover:bg-primary/90 transition-all-medium"
                >
                  <Save size={16} />
                  <span>Save</span>
                </button>
              ...
              <div>
                <div className="flex items-start justify-between mb-6">
                  ...
                  <div className="text-sm text-muted-foreground">
                    Patient since {format(new Date(patient.createdAt), 'MMM d, yyyy')}
                  </div>
                </div>
                ...
                {(patient.diagnosis || patient.notes) && (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                    {patient.diagnosis && (
                      <div>
                        <h3 className="text-sm uppercase tracking-wider text-muted-foreground mb-1">Diagnosis</h3>
                    ...
                    {patient.notes && (
                      <div>
                        <h3 className="text-sm uppercase tracking-wider text-muted-foreground mb-1">Notes</h3>
                        <p>{patient.notes}</p>
                      </div>
                    )}
                  </div>
